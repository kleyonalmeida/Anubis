...
namespace Anubis.Presentation.CLI.UI;
...
";
    ...
    public static void PrintVulnerability(string description, Anubis.Domain.Enums.VulnerabilitySeverity severity)
    {
        string color = severity switch
        {
            Anubis.Domain.Enums.VulnerabilitySeverity.Critical => Red,
            Anubis.Domain.Enums.VulnerabilitySeverity.High => Red,
            Anubis.Domain.Enums.VulnerabilitySeverity.Medium => Yellow,
            Anubis.Domain.Enums.VulnerabilitySeverity.Low => Cyan,
            _ => Blue
        };
