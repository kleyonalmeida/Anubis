...
public class CveLookupServiceTests : IDisposable
{
    ...
    private readonly Mock<ILogger<Anubis.Application.Services.CveLookupService>> _mockLogger;

    public CveLookupServiceTests()
    {
        _wireMockServer = WireMockServer.Start();
        _mockLogger = new Mock<ILogger<Anubis.Application.Services.CveLookupService>>();
    }
    ...
    public async Task SearchByCveIdAsync_ShouldExtractCriticalSeverityAndScore_WithAotJson()
    {
        ...
        var nvdApiClientLogger = new Mock<ILogger<Anubis.Infrastructure.Network.NvdApiClient>>();
        var nvdApiClient = new Anubis.Infrastructure.Network.NvdApiClient(mockHttpClientFactory.Object, nvdApiClientLogger.Object);
        var service = new Anubis.Application.Services.CveLookupService(nvdApiClient, _mockLogger.Object);
